...
\begin{tcolorbox}[colback=yellow!8,colframe=orange!60!black,title=\textbf{Overnight update --- 2026-04-19/20}]
...
\begin{enumerate}[leftmargin=*,topsep=2pt]
  \item \textbf{The $-76.86$~dB SMF-28 single-mode optimum is stable.}
        Phase 21 reproduced it on a validator-controlled grid; Phase 22
        reproduced it again under the plain log-dB objective
        ($-76.86$~dB, $\sigma_{3\text{dB}}=0.025$~rad).
