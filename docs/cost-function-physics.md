...
The physics behind the optimizer at the level a new team member needs to
understand *why* it works. Full math lives in
[`./companion_explainer.pdf`](./companion_explainer.pdf) (first-principles,
undergrad-friendly) and
[`./verification_document.pdf`](./verification_document.pdf) (equation-by-
equation code verification). Additional notes in
[`./physics_verification.pdf`](./physics_verification.pdf).
...
[`./companion_explainer.pdf`](./companion_explainer.pdf).
...
- [`./companion_explainer.pdf`](./companion_explainer.pdf) — first-principles math walkthrough
- [`./verification_document.pdf`](./verification_document.pdf) — equation-by-equation code verification
...
- [interpreting-plots.md](./interpreting-plots.md) — what the cost looks like
