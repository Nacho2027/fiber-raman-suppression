...
> **Status — stub.** Multi-variable optimization support is still being
> documented. This file exists as the current framework-level scaffold until
> the fuller guide is written.
...
[cost-function-physics.md](../architecture/cost-function-physics.md#why-spectral-phase-not-amplitude).
...
6. Document the new variable's schema in
   [../architecture/output-format.md](../architecture/output-format.md).

## See also

- [cost-function-physics.md](../architecture/cost-function-physics.md) — cost + adjoint math.
- [output-format.md](../architecture/output-format.md) — schema versioning for new fields.
