...
tags: [matplotlib, pyplot, raman, colorblind, okabe-ito, julia]

# Dependency graph
requires:
  - phase: 01-PLAN-01
    provides: "Okabe-Ito color constants (COLOR_INPUT, COLOR_OUTPUT, COLOR_RAMAN, COLOR_REF), inferno colormap, PyDict rcParams"
provides:
...
affects: [02-stop-hiding-information, 03-self-documenting-plots]

# Tech tracking
tech-stack:
  added: []
  patterns:
    - "Two-sided frequency window for Raman band: abs.(Df .- center) .< half_bw"
    - "Explicit color= and ls= kwargs instead of matplotlib format strings"
...
requirements-completed: [BUG-01, STYLE-01, STYLE-02]
