...
\subsection{No-Shaping Control}
\begin{figure}[H]
\centering
\includegraphics[width=0.70\linewidth]{figures/mmf_control_evolution.png}
\caption{No-shaping control for the accepted MMF operating point. This is the
baseline heat map for judging whether the shared spectral phase changed Raman
growth.}
\end{figure}

\subsection{Rejected Unregularized Run}
\begin{figure}[H]
\centering
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=\linewidth]{figures/mmf_rejected_unregularized_phase_diagnostic.png}
\caption*{Rejected unregularized phase diagnostic.}
\end{minipage}
\hfill
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=\linewidth]{figures/mmf_rejected_unregularized_evolution.png}
\caption*{Rejected unregularized heat map.}
\end{minipage}
...
\subsection{Accepted Boundary+GDD Run}
\begin{figure}[H]
\centering
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=\linewidth]{figures/mmf_accepted_phase_diagnostic.png}
\caption*{Accepted phase diagnostic.}
\end{minipage}
\hfill
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=\linewidth]{figures/mmf_accepted_evolution.png}
\caption*{Accepted optimized heat map.}
\end{minipage}
