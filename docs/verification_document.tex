...
\end{equation}
The $10/(J\ln 10)$ factor maintains $O(1)$ gradient magnitude as $J \to 0$, preventing L-BFGS stall. Default: \texttt{log\_cost=true}, \texttt{f\_abstol=0.01}~dB. \textbf{Result:} 20--28~dB improvement across all sweep points.
\end{verified}
