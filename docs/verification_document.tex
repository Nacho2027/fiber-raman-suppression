...
\end{itemize}
with all trusted runs clean on BC edge and energy drift. The
suppression at 100~m is therefore \textbf{generic dispersive
...
\begin{advisory}
\textbf{Practical takeaway.} SAM fell out of contention across both
operating points (best $\sigma$-shift $\leq 0.006$~rad). The default
...
depth cost; on Pareto-57 the cheapest trade is
$\lambda_{\text{trH}}{=}3\times10^{-3}$ at $13.18$~dB for a
$+0.032$~rad tolerance gain. The Pareto-57 plain optimum cross-validates
