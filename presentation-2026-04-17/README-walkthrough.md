...
These are in the top of the `presentation-2026-04-17/` folder (not in `pedagogical/`). They're from the **older** baseline studies (Nt=8192 full-resolution L-BFGS) done before we understood the saddle issue or the low-res basis.
