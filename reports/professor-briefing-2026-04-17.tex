...
\graphicspath{{../presentation-2026-04-17/}}
...
\begin{itemize}[leftmargin=*]
  \item \textbf{Multi-variable optimizer} (joint $\varphi$, amplitude $A$, pulse energy $E$ in one adjoint solve) --- 1000 LoC, 42/42 unit tests pass, gradient FD check and SMF-28 A/B demo pending.
...
\textbf{Figures folder:} \texttt{presentation-2026-04-17/} (17 PNGs, named by topic so you can pull them up in order). \textbf{Full technical report:} \texttt{reports/overnight-synthesis-2026-04-17.pdf} (22 pages, every claim traceable to a file path).
