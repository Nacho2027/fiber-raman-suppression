...
# ═══════════════════════════════════════════════════════════════════════════════
#
# Invoked by scripts/phase15_benchmark.jl as:
#   julia --project=. scripts/_phase15_benchmark_run.jl (measure|estimate) <tag>
#
...
# driver swaps those files between legs — see scripts/phase15_benchmark.jl.
# ═══════════════════════════════════════════════════════════════════════════════
