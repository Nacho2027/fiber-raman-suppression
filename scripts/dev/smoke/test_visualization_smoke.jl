...
viz_source = read(joinpath(@__DIR__, "..", "..", "lib", "visualization.jl"), String)
...
raman_src = read(joinpath(@__DIR__, "..", "..", "lib", "raman_optimization.jl"), String)
...
viz_src = read(joinpath(@__DIR__, "..", "..", "lib", "visualization.jl"), String)
