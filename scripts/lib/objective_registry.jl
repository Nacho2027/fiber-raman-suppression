...
const OBJECTIVE_CONTRACTS = (
    (
        ...
        description = "Integrated red-detuned spectral leakage with optional regularization; Raman attribution requires a matched Raman-off scenario.",
        maturity = "supported",
        supported_variables = (
            (:phase,),
            (:reduced_phase,),
    ...
    (
        ...
        regime = :single_mode,
        backend = :raman_optimization,
        description = "Maximum single-bin red-detuned leakage with optional phase regularization; not a Raman-specific observable by itself.",
    ...
    (
        ...
        regime = :long_fiber,
        backend = :raman_optimization,
        description = "Integrated red-detuned spectral leakage for long-fiber planning; not a Raman-specific observable by itself.",
        maturity = "experimental",
    ...
    (
        ...
        description = "Mode-summed red-detuned leakage for shared spectral-phase planning; Raman attribution requires a counterfactual.",
        maturity = "experimental",
        supported_variables = ((:phase,),),
    ...
    (
        ...
        regime = :multimode,
        backend = :mmf_raman_optimization,
        description = "Fundamental-mode red-detuned leakage diagnostic; not Raman-specific by itself.",
        maturity = "experimental",
        supported_variables = ((:phase,),),
    ...
    (
        ...
        regime = :multimode,
        backend = :mmf_raman_optimization,
        description = "True worst-mode red-detuned leakage reporting with a bounded normalized-LSE proxy.",
        maturity = "experimental",
        supported_variables = ((:phase,),),
