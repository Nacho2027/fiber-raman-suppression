...
function render_results_index(index; io::Union{Nothing,IO}=nothing)
    lines = String[
        ...
        "- Entries: `$(index.total)`",
        "",
        "| Kind | ID | Config | Regime | Objective | Variables | Fiber | L [m] | P [W] | J_after [dB] | ΔJ [dB] | Quality | Lab Ready | Readiness | Std Images | Variable Artifacts | Trust | Export | Path |",
        "|---|---|---|---|---|---|---|---:|---:|---:|---:|---|---|---|---|---|---|---|---|",
    ]
...
function render_results_comparison(comparison; io::Union{Nothing,IO}=nothing)
    lines = String[
        ...
        "",
        "| Rank | Lab Ready | Readiness | Config | Objective | Variables | Fiber | L [m] | P [W] | J_after [dB] | ΔJ [dB] | Quality | Std Images | Variable Artifacts | Trust | Export | Path |",
        "|---:|---|---|---|---|---|---|---:|---:|---:|---:|---|---|---|---|---|---|",
    ]
