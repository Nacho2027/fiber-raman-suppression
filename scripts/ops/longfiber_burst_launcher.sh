...
log "             --project=. scripts/research/longfiber/longfiber_optimize_100m.jl'\""
log ""
...
run_light "T4-100m-forward" "scripts/research/longfiber/longfiber_forward_100m.jl"
run_light "T3-50m-validate" "scripts/research/longfiber/longfiber_validate_50m.jl"
run_light "T6-100m-validate" "scripts/research/longfiber/longfiber_validate_100m.jl"
