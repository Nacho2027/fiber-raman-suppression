...
READ-ONLY consumer of:
  * scripts/phase13_hvp.jl      — fd_hvp, build_oracle, ensure_deterministic_fftw
  * scripts/phase13_primitives.jl — input_band_mask, omega_vector, gauge_fix
...
Usage:
  julia --project=. --threads=auto scripts/phase13_hessian_eigspec.jl --config smf28_canonical
  julia --project=. --threads=auto scripts/phase13_hessian_eigspec.jl --config hnlf_canonical
  julia --project=. --threads=auto scripts/phase13_hessian_eigspec.jl --figures   # produces the 3 combined figures after both JLD2 exist
...
include(joinpath(@__DIR__, "phase13_hvp.jl"))   # brings phase13_primitives too
