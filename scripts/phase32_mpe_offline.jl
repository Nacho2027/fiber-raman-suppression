...
#   3. Inline 3-step ladder (mirrors scripts/phase30_demo.jl).
#
...
#              'julia -t auto --project=. scripts/phase32_mpe_offline.jl'"
...
function _render_experiment2_section(
    ...
    println(buf, "")
    println(buf, "_populated by scripts/phase32_mpe_offline.jl_")
    println(buf, "")
