# scripts/phase34_benchmark_run.jl — Phase 34 Plan 04 benchmark driver.
#
...
#                'julia -t auto --project=. scripts/phase34_benchmark_run.jl'"
#
...
include(joinpath(@__DIR__, "trust_region_preconditioner.jl"))   # NEW Phase 34
include(joinpath(@__DIR__, "trust_region_pcg.jl"))              # NEW Phase 34
