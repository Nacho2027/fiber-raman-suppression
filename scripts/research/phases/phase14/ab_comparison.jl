...
#   scripts/hvp.jl         — fd_hvp (for saddle-point diagnostic at each optimum)
#   scripts/primitives.jl  — input_band_mask, omega_vector
...
include(joinpath(@__DIR__, "..", "phase13", "hvp.jl"))              # brings phase13_primitives
...
the signature hvp.jl :: fd_hvp expects.
"""
...
using the symmetric-FD HVP from `scripts/hvp.jl :: fd_hvp`. Returns
