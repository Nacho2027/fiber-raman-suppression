...
#       after gauge-fix (from scripts/primitives.jl :: gauge_fix).
#       Input band highlighted.
#
# Data sources:
#   results/raman/phase14/ab_results.jld2         (from ab_comparison.jl)
#   results/raman/phase14/robustness_results.jld2 (from robustness_test.jl)
#
...
include(joinpath(@__DIR__, "..", "phase13", "primitives.jl"))
