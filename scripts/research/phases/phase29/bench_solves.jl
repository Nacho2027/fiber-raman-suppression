...
Fits Amdahl (via scripts/roofline_model.jl). Persists
...
(Phase 15 pattern, scripts/benchmark.jl:120-147).
"""
...
# ─────────────────────────────────────────────────────────────────────────────
# Subprocess dispatch (mirrors scripts/benchmark.jl::_run_one_subprocess)
# ─────────────────────────────────────────────────────────────────────────────

"""
    _run_one_subprocess(mode, tag, n_threads) -> NamedTuple

Spawns `julia -t n_threads --project=... bench_solves_run.jl mode tag`,
