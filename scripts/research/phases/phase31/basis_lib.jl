# scripts/basis_lib.jl — Phase 31 basis library extension
# Adds :polynomial (Legendre, gauge-free starting at start_order=2) and
# :chirp_ladder (fixed 4 columns: ω², ω³, ω⁴, ω⁵) kinds. Reuses
# build_phase_basis from `scripts/research/sweep_simple/sweep_simple_param.jl`
# for :cubic/:dct/:linear/:identity.
#
