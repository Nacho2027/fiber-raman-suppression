...
include(joinpath(@__DIR__, "..", "..", "sweep_simple", "sweep_simple_param.jl"))
include(joinpath(@__DIR__, "..", "phase13", "primitives.jl"))
include(joinpath(@__DIR__, "..", "phase13", "hvp.jl"))
...
Mirrors `multistart_seeds` from `scripts/research/sweep_simple/sweep_simple_run.jl`
(identical signature).
"""
