...
#              'julia -t auto --project=. scripts/richardson_audit.jl'"
...
include(joinpath(@__DIR__, "..", "..", "analysis", "acceleration.jl"))
...
function _append_results_md(audit::Dict{String,Any})
    ...
    push!(lines, "")
    push!(lines, "_populated by scripts/richardson_audit.jl_")
    push!(lines, "")
