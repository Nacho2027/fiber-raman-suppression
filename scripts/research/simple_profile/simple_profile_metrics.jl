...
# ═══════════════════════════════════════════════════════════════════════════════
#
#   julia --project=. scripts/research/simple_profile/simple_profile_metrics.jl
#
# Consumes:
...
function main()
    ...
    @assert isfile(baseline_path) "baseline.jld2 missing — run scripts/research/simple_profile/simple_profile_driver.jl --stage=baseline first"
