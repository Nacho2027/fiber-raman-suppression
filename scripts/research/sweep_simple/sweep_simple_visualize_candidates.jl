...
#
# Output directory: docs/artifacts/presentation-2026-04-17/standard-format/
...
const OUTDIR = joinpath(ROOT, "docs", "artifacts", "presentation-2026-04-17", "standard-format")
mkpath(OUTDIR)
