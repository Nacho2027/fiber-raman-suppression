...
# ═══════════════════════════════════════════════════════════════════════════════
#
# Complement to `scripts/raman_optimization.jl`. Both entry points coexist:
...
#   1. Zero writes to scripts/common.jl, scripts/raman_optimization.jl, src/.
...
# ─────────────────────────────────────────────────────────────────────────────
# Input-band mask (local helper, to avoid depending on phase13_primitives.jl
...
`scripts/phase13_primitives.jl :: input_band_mask`; we re-derive it here to
...
`scripts/raman_optimization.jl`, optionally with log-scaling (`log_cost`)
