...
Reads the JLD2 files produced by sweep_simple_run.jl, computes the
...
Usage
=====
  julia --project=. scripts/sweep_simple_analyze.jl
"""
...
function write_handoff(candidates)
    ...
    push!(lines, "  mask; see `scripts/sweep_simple_param.jl` for definitions.")
