...
Usage:
  julia --project scripts/workflows/run_benchmarks.jl
...
Depends on:
  ...
  - scripts/lib/common.jl (setup_raman_problem, FIBER_PRESETS)
  - scripts/lib/visualization.jl (plot_time_window_analysis_v2)
"""

include(joinpath(@__DIR__, "..", "research", "benchmarks", "benchmark_optimization.jl"))

function run_benchmarks_main()
    @info "═══════════════════════════════════════════"
