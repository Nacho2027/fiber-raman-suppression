...
@testset "Repository structure" begin
    ...
    @test occursin("Supported lab rollout", closure_text)
    @test occursin("Evidence checked", closure_text)
    ...
    @test occursin("Local gate", lab_readiness_text)
    @test occursin("Artifact gate", lab_readiness_text)
    @test occursin("Not lab-ready by default", lab_readiness_text)
    supported_workflows_text = read(supported_workflows_guide, String)
    @test occursin("make golden-smoke", supported_workflows_text)
    @test occursin("Use `./fiberlab explore ...`", supported_workflows_text)
    first_lab_user_text = read(first_lab_user_guide, String)
    @test occursin("make doctor", first_lab_user_text)
    @test occursin("make golden-smoke", first_lab_user_text)
    @test occursin("./fiberlab ready latest research_engine_poc", first_lab_user_text)
    @test occursin("standard images", first_lab_user_text)
    golden_smoke_text = read(golden_smoke_guide, String)
    @test occursin("make golden-smoke", golden_smoke_text)
    @test occursin("results/raman/smoke/", golden_smoke_text)
